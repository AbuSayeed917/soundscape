    ...
    <section className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden px-6 py-24">
      ...
      >
        <Link href="/studio">
          <Button
            size="lg"
            className="gap-2 rounded-full bg-[#FF6B6B] px-8 py-6 text-base font-bold text-white cartoon-shadow-lg transition-transform hover:scale-105 hover:bg-[#FF5252]"
          >
            Open Studio
        ...
        <a href="#how-it-works">
          <Button
            variant="outline"
            size="lg"
            className="rounded-full border-2 border-[#4ECDC4] px-8 py-6 text-base font-bold text-[#4ECDC4] cartoon-shadow transition-transform hover:scale-105 hover:bg-[#4ECDC4] hover:text-white"
          >
            How it works
          </Button>
        </a>
      ...
      >
        {FEATURES.map((f, i) => (
          <motion.div
            ...
            custom={i}
            className={`group relative overflow-hidden rounded-3xl border-2 border-border ${f.bg} p-6 cartoon-shadow wobble-hover transition-transform hover:scale-[1.03]`}
          >
            <div
